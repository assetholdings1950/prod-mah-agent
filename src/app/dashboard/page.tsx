...
import {
  Award, TrendingUp, Users, Wallet, Activity, Mail, User, ShieldCheck, Layers, Copy, Check, Loader2, ChevronRight, Plus
} from "lucide-react";
...
export default function DashboardPage() {
  ...
  const totalClientsCount = user?.totalClients !== undefined ? user.totalClients : (clients.length || 0);
  const activeClientsCount = user?.activeClients !== undefined ? user.activeClients : 0;
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl shadow-sm p-6 flex flex-col">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-4">
              <div>
                ...
                <p className="text-xs text-navy-light/50 font-normal">A quick snapshot of your recently referred investors</p>
              </div>
              <Link
            ...
            {clientsLoading ? (
              ...
              <div className="text-center py-12 bg-slate-50/50 rounded-xl border border-dashed border-slate-200">
                ...
                <p className="text-xs font-bold text-navy">No referred clients yet</p>
                <p className="text-[10px] text-slate-400 mt-0.5">Share your referral code to register your first client.</p>
                <Link
                  href="/dashboard/clients"
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-slate-100 pt-3 mt-3">
                ...
                <div className="space-y-1.5 text-[11px] font-semibold text-navy">
                  <div className={`flex items-center justify-between p-1.5 rounded-lg ${user?.agentLevel === "basic" ? "bg-navy/5 font-bold" : "text-navy-light/60 font-normal"}`}>
                    <span>Basic Partner (≤ 5 Sales)</span>
                    <span>2%</span>
                  </div>
                  <div className={`flex items-center justify-between p-1.5 rounded-lg ${user?.agentLevel === "silver" ? "bg-navy/5 font-bold" : "text-navy-light/60 font-normal"}`}>
                    <span>Silver Partner (6–10 Sales)</span>
                    <span>5%</span>
                  </div>
                  <div className={`flex items-center justify-between p-1.5 rounded-lg ${user?.agentLevel === "gold" ? "bg-navy/5 font-bold" : "text-navy-light/60 font-normal"}`}>
                    <span>Gold Partner (11–20 Sales)</span>
                    <span>7%</span>
                  </div>
                  <div className={`flex items-center justify-between p-1.5 rounded-lg ${user?.agentLevel === "diamond" ? "bg-navy/5 font-bold" : "text-navy-light/60 font-normal"}`}>
                    <span>Diamond Partner (21+ Sales)</span>
                    <span>10%</span>
                  </div>
                </div>
              </div>
